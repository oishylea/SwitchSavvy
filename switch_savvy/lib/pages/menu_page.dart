...
class _MenuPageState extends State<MenuPage> {
  List<Game> gameCatalog = [
    ...
    desc: "Free the wizard Academy of Greifenstein from magical creatures by using your spells in creative ways. Play in local co-op with your friends or family, customize your own student wizard, solve mysteries and find powerful artifacts in this modern magical world.",rating: "4.1")
  ];
